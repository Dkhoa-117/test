...
export const createStory = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await API.post(`/api/stories`, {}, config);
...
export const myStories = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await API.get(`/api/stories/my_stories`, config);
...
export const createStoryComment = (storyId, comment) => async (dispatch, getState) => {
    try {
        ...
        await API.post(`/api/stories/${storyId}/comments`, comment, config);
...
export const listTopStories = () => async (dispatch) => {
    try {
        ...
        const { data } = await API.get(`/api/stories/top`);
